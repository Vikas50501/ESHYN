...
const PRODUCTS = [
  {
    ...
    scent: {
      notes: { top: ['Citrus', 'Green Leaf', 'Bergamot'], heart: ['Wet Earth', 'Rose', 'Saffron'], base: ['Sandalwood', 'Musk', 'Amber'] },
      noteImages: { Citrus: 'terracotta', 'Green Leaf': 'olive', Bergamot: 'sand', 'Wet Earth': 'gold', Rose: 'espresso', Saffron: 'ink', Sandalwood: 'clay', Musk: 'blush', Amber: 'terracotta' },
  ...
  },
  {
    ...
    collections: ['attars', 'bestsellers'],
    scent: {
      notes: { top: ['Bergamot', 'Cardamom'], heart: ['Rose', 'Saffron', 'Geranium'], base: ['Mysore Sandalwood', 'Amber', 'Vanilla'] },
      noteImages: { Bergamot: 'terracotta', Cardamom: 'blush', Rose: 'olive', Saffron: 'gold', Geranium: 'sand', 'Mysore Sandalwood': 'espresso', Amber: 'clay', Vanilla: 'ink' },
  ...
  },
  {
    ...
    collections: ['attars'],
    scent: {
      notes: { top: ['Green Leaf', 'Litchi', 'Bergamot'], heart: ['Damask Rose', 'Mogra', 'Saffron'], base: ['Musk', 'Sandalwood', 'Amber'] },
      noteImages: { 'Green Leaf': 'terracotta', Litchi: 'olive', Bergamot: 'sand', 'Damask Rose': 'gold', Mogra: 'espresso', Saffron: 'ink', Musk: 'clay', Sandalwood: 'blush', Amber: 'terracotta' },
  ...
  },
  {
    ...
    scent: {
      notes: { top: ['Bergamot', 'Pink Pepper', 'Cardamom'], heart: ['Champa Blossom', 'Ylang Ylang', 'Jasmine'], base: ['Musk', 'Vanilla Bean', 'Sandalwood'] },
      noteImages: { Bergamot: 'terracotta', 'Pink Pepper': 'olive', Cardamom: 'sand', 'Champa Blossom': 'gold', 'Ylang Ylang': 'espresso', Jasmine: 'ink', Musk: 'clay', 'Vanilla Bean': 'blush', Sandalwood: 'terracotta' },
  ...
  },
  {
    ...
    scent: {
      notes: { top: ['Saffron', 'Rose', 'Cardamom'], heart: ['Cambodian Oud', 'Amber', 'Leather'], base: ['Musk', 'Sandalwood', 'Vetiver'] },
      noteImages: { Saffron: 'terracotta', Rose: 'olive', Cardamom: 'sand', 'Cambodian Oud': 'gold', Amber: 'espresso', Leather: 'ink', Musk: 'clay', Sandalwood: 'blush', Vetiver: 'terracotta' },
      longevity: 9, projection: 'Strong', intensity: 'Strong',
  ...
  },
  {
    ...
    collections: ['eau-de-parfum', 'new-arrivals'],
    scent: {
      notes: { top: ['Vetiver', 'Bergamot', 'Grapefruit'], heart: ['Fig Leaf', 'Green Accord', 'Sage'], base: ['Cedar', 'Musk', 'Oakmoss'] },
      noteImages: { Vetiver: 'terracotta', Bergamot: 'olive', Grapefruit: 'sand', 'Fig Leaf': 'gold', 'Green Accord': 'espresso', Sage: 'ink', Cedar: 'clay', Musk: 'blush', Oakmoss: 'terracotta' },
  ...
  },
  {
    ...
    scent: {
      notes: { top: ['Citrus', 'Bergamot', 'Mandarin'], heart: ['Rose', 'Oud', 'Jasmine'], base: ['Sandalwood', 'Musk', 'Amber'] },
      noteImages: { Citrus: 'terracotta', Bergamot: 'olive', Mandarin: 'sand', Rose: 'gold', Oud: 'espresso', Jasmine: 'ink', Sandalwood: 'clay', Musk: 'blush', Amber: 'terracotta' },
      longevity: 7, projection: 'Moderate', intensity: 'Moderate',
  ...
  },
  {
    ...
    collections: ['attars'],
    scent: {
      notes: { top: ['Cardamom', 'Pink Pepper'], heart: ['Black Musk', 'Patchouli'], base: ['Dark Amber', 'Leather'] },
      noteImages: { Cardamom: 'terracotta', 'Pink Pepper': 'espresso', 'Black Musk': 'olive', Patchouli: 'clay', 'Dark Amber': 'gold', Leather: 'blush' },
      longevity: 8, projection: 'Strong', intensity: 'Strong',
